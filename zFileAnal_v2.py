...
# ─────────────────────────────────────────────
# 5 — GROUP IMAGE/VIDEO FILES BY DATE
# ─────────────────────────────────────────────
...
MENU = [
    ...
    ("6", "MEDIA",            "Group image/video files by date",     group_files_by_date),
    ("7", "SCANNING",         "List subfolders & save to file",      list_subfolders_and_save),
    ("8", None,               "Find Study IDs in files & folders",   find_study_ids),
    ("9", "COMPARISON",       "Compare two folders (recursive)",     compare_two_folders),
    ("0", None,               "Exit",                                None),
]
...
if __name__ == "__main__":
    ...
    print()
    print(c("  ╔══════════════════════════════════════╗", CYAN))
    print(c("  ║       finalAnalisis — v2.0           ║", CYAN + BOLD))
