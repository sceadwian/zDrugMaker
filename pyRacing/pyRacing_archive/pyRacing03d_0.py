...
#version 3d Added new attributes + load driver attributes
...
class Car:
    def __init__(self, symbol, cc_maxSpd, cc_accel, cc_dragC, cc_downC, cc_cornr, cc_ovrtk, cc_const, cc_defnd, cc_stam):
        self.symbol = symbol
        # Car characteristics
...
def main():
    ...
    cars = [Car(symbol=chr(65 + i), cc_maxSpd=random.randint(300, 350),
                ...
                cc_ovrtk=random.randint(50, 70), cc_const=random.randint(50, 70),
                cc_defnd=random.randint(50, 70), cc_stam=random.randint(50, 70),
